 ...
 * Job constructor.
 *
 * A job is the interface between your logic and
 * a roach server (based on redis).
 *
 ...
 *
 * A job has to subscribe to roach in order to be 
 * runned in a separate process.
 * 
 * Examples:
 *
 *   job.subscribe('myjob');
 ...
 * Config handler.
 *
 * It is useful to add a default config
 * to your job. The config will be merged 
 * with the job options (stored in redis).
 * 
 * Examples:
 *
 *   //get
 ...
 *
 * Data will be used by transport layers.
 * 
 * Examples:
 *
 *   .data('something');
