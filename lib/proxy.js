 ...
 * @api public
 */
Proxy.prototype.isExcelFile = function(filename){
...
Proxy.prototype._readFile = function() {
  ...
  fs.stat(file, function(error, stats){
    ...
    fs.readFile(file, function(error, data){
      ...
      if ( self.isZipFile(self.options.file) || self.isExcelFile(self.options.file) ) {
...
Proxy.prototype._visit = function() {
  ...
  if ( this.isZipFile(this.options.url) || this.isExcelFile(this.options.url) ) {
  ...
  request.get(this.options, function(error, response, body){
    ...
    if ( self.isZipFile(self.options.url) || self.isExcelFile(self.options.url) ) {
