...
exports.pending = 'roach:jobs:pending';
exports.active = 'roach:jobs:active';
exports.complete = 'roach:jobs:complete';
exports.failed = 'roach:jobs:failed';
...
function Queue(options) {
  ...
  // Do we need this here? Can we just use this.client?
...
Queue.prototype.remove = function(id, cb) {
  ...
  this.client.zrem('roach:jobs:active', id, function(err) {
    if(!err) {
      ...
      _this.client.zadd('roach:jobs:complete', id, id, function(err, res) {
        if(!err) {
          // Let's just make sure that the job is removed from
          // the pending queue.
